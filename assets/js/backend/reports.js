...
var appreport = new Vue({
    ...
    data() {
        return {
            ...
            columns: ['inv_number', 'campaign_name','first_name', 'amount','status', 'transfer_date', 'transection_no', 'paymentchanel', 'pan', 'bankName', 'updated_date', 'action', 'action_email'],
            options: {
                headings: {
                    inv_number: 'เลขที่ใบเสร็จ.',
                    ...
                    transection_no: 'เลขที่อ้างอิงการชำระเงิน.',
                    paymentchanel: 'ช่องทางชำระ',
                    pan: 'เลขที่บัตร',
                    bankName: 'ธนาคาร',
                    updated_date: "วันที่ทำรายการล่าสุด",
                    action: "",
                    action_email: "",

                },
                pagination: {chunk: 10},
                sortable: ['inv_number', 'first_name', 'transection_no','updated_date','transfer_date'],
                filterable: ['inv_number', 'first_name', 'transection_no','updated_date','transfer_date'],
                perPage: 10,
