            ...
            <div class="d-flex">
                ...
                <div class="tab-body mb-5 d-none" id="tab-body-2">
                    ...
                    <div class="subject-1">
                        ...
                        <p>ผู้เสียหายจำนวนมากที่ได้รับความเดือดร้อน ไม่มีทุนทรัพย์พอ ในการฟ้องคดี จึงมาขอความช่วยเหลือจาก “ศูนย์ทนายความเพื่อการคุ้มครองผู้บริโภค มูลนิธิเพื่อผู้บริโภค”  ซึ่งนับตั้งแต่ปี 2548 จนถึงปี 2559 ศูนย์ทนายความฯ มีผลการดำเนินคดีเพื่อคุ้มครองสิทธิอันพึงมีพึงได้ของผู้บริโภค จำนวนทั้งสิ้น 534 คดี</p>
                    </div>
                ...
                <div class="tab-body mb-5 d-none" id="tab-body-3">
                    ...
                    <h2 class="mt-5 mb-4 mt-4-lg  text-center">Safety Online Payments Protection</h2>
                    <div class="d-flex">
                        <p>เว็บไซต์ของเรามีความปลอดภัย<br>ข้อมูลบัตรเครดิตรของคุณจะไม่ถูกเก็บไว้ในระบบ<br>ขณะที่ข้อมูลส่วนบุคคลของคุณ<br>ได้รับการปกป้องตามนโยบายรักษาความเป็นส่วนตัว</p>
                    </div>
                    <p class="subject-3 mb-4">มูลนิธิเพื่อผู้บริโภคเป็นองค์กรสาธารณะประโยชน์ ลำดับที่ 576 ตามประกาศกระทรวงการคลัง
                ...
                <div class="mt-2">
                    <div class="d-flex position-relative">
                        <div class="position-relative pointer">
                            ...
                            <p class="position-absolute state-1 state-active">1 จำนวนเงิน</p>
                        </div>
                        <div class="position-relative pointer">
                            <img src="<?php echo base_url('assets/img/state-button-2-gray.png')?>" class="mr-3 ml-3 w-75-lg">
                            <p class="position-absolute state-2">2 รายละเอียด</p>
                        </div>
                        <div class="position-relative pointer">
            ...
            <div class="payment-container d-none" id="payment-2">
                ...
                <div class="mt-2">
                    <div class="d-flex position-relative pointer">
                        ...
                        <div class="position-relative pointer">
                            <img src="<?php echo base_url('assets/img/state-button-1.png')?>" class="mr-3 ml-3 w-75-lg">
                    ...
                    <div id="donate-choose">
                        ...
                        <div class="payment-choose-container position-relative mt-3">
                            <label class="radio-label mb-0"> ไม่ประสงค์ออกนาม
                                <input type="radio" name="donate-type" id="donate-type-1" value="type-1" checked="checked">
                    ...
                    <div id="bill" class="mt-4">
                        ...
                        <div class="row mt-2 position-relative">
                            ...
                            <div class="col-6-xl col-12-lg pr-0 pl-5 pl-4-lg mr-2">
                                <label class="state-2-label mb-1 pl-1 mr-2">ชื่อ / บริษัท ผู้บริจาค<span> *</span></label>
            ...
            <div class="payment-container d-none" id="payment-3">
                ...
                <div class="mt-2">
                    <div class="d-flex position-relative">
                        ...
                        <div class="position-relative pointer">
                            <img src="<?php echo base_url('assets/img/state-button-2-gray.png')?>" class="mr-3 ml-3 w-75-lg" id="payment-3_state-2">
                    ...
                    <div id="payment-choose">
                        ...
                        <div class="payment-choose-container position-relative mt-4">
                            ...
                            <img src="<?php echo base_url('assets/img/prompt-pay-icon.png')?>" class="ml-4 mt-2 d-none d-lg-inline-block">
                            <img src="<?php echo base_url('assets/img/qr-icon.png')?>" class="ml-3 mt-2 d-none d-lg-inline-block">
                        </div>
                        <div class="payment-choose-container position-relative mt-4">
                            ...
                            <img src="<?php echo base_url('assets/img/scb-icon.png')?>" class="ml-4 mt-2 d-none d-lg-inline-block">
                            <img src="<?php echo base_url('assets/img/kbank-icon.png')?>" class="mt-2 d-none d-lg-inline-block">
                            <img src="<?php echo base_url('assets/img/bay-icon.png')?>" class="mt-2 d-none d-lg-inline-block">
                            <img src="<?php echo base_url('assets/img/ktb-icon.png')?>" class="mt-2 d-none d-lg-inline-block">
                    ...
                    <div id="payment-type-2" class="d-none">
                        ...
                        <p class="text-center mt-3">คุณสามารถบริจาคผ่าน QR Code ทุกธนาคาร หรือ Mobile Banking ของธนาคารของคุณ</p>
                        <div class="row">
                            <div class="col-xl-5 pr-0 text-center">
                                <div>
                                    <img src="<?php echo base_url('assets/img/prompt-pay-icon.png')?>" class="mb-2 mr-2 h-20">
                                </div>
                                <div>
                            ...
                            <div class="col-xl-7 pl-0">
                                <div class="qr-text-container">
                                    <ol class="pl-4 mb-0">
                                        ...
                                        <li class="qr-text">ตรวจสอบยอดเงิน และชื่อบัญชี ว่าใช่มูลนิธิที่คุณ กำลังจะบริจาคหรือไม่</li>
                                        <li class="qr-text">เมื่อทำรายการบน Mobile Banking เรียบร้อย หน้าจอจะแสดงผลสำเร็จ</li>
                            ...
                            <div class="col-xl-10 col-12-lg mt-4">
                                ...
                                <div class="transfer-body">
                                    ...
                                    <p class="mb-0">2. ส่งมาที่ อีเมล donationffc@gmail.com  หรือ  3. ส่งมาที่ ไลน์แอท @chaladsue.online
                                        พร้อมใส่รายละเอียดชื่อ - ที่อยู่ ที่จะให้ทางมูลนิธิฯ ออกใบเสร็จรับเงิน เพื่อใช้ในการลดหย่อนภาษี
                            ...
                            <div class="col-xl-6 col-lg-12 upload-container d-flex ml-5">
                                ...
                                <div class="inputWrapper">
                                    ...
                                    <img src="<?php echo base_url('assets/img/upload-icon.png')?>" class="position-absolute upload-icon">
                                </div>
                            </div>
                            <div class="d-flex col-lg-12 mt-4 ml-4">
                                <button class="next position-relative mb-4 done"><span class="position-absolute"><i class="fa fa-angle-double-right"></i></span>Next</button>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-xl-6 col-lg-12 pl-4">
                                    <div class="row">
                                        <div class="col-3 pr-0">
                                            <img src="<?php echo base_url('assets/img/scb-icon-45.png')?>" class="h-30">
                                        </div>
                                        ...
                                        <div class="col-3 pr-0 mt-3">
                                            <img src="<?php echo base_url('assets/img/bay-icon-45.png')?>" class="h-30">
                                        </div>
                                        ...
                                        <div class="col-3 pr-0 mt-3">
                                            <img src="<?php echo base_url('assets/img/bbl-icon-45.png')?>" class="h-30">
                                        </div>
                                ...
                                <div class="col-xl-6 col-lg-12  pl-4-lg">
                                    <div class="row pr-4 pr-0-lg mt-3-lg">
                                        <div class="col-3 pr-0 pr-0-lg">
                                            <img src="<?php echo base_url('assets/img/kbank-icon-45.png')?>" class="h-30">
                                        </div>
                                        <div class="col-9 pl-0 pr-0">
                                        ...
                                        <div class="col-3 pr-0 mt-3">
                                            <img src="<?php echo base_url('assets/img/ktb-icon-45.png')?>" class="h-30">
                                        </div>
                                        <div class="col-9 pl-0 pr-0 mt-3">
